module Enterprise::Account::PlanUsageAndLimits # rubocop:disable Metrics/ModuleLength
  ...
  def subscribed_features
    plan_features = InstallationConfig.find_by(name: 'STRAVOX_CLOUD_PLAN_FEATURES')&.value
  ...
  def default_captain_limits
    max_limits = { documents: ::StravoXApp.max_limit, responses: ::StravoXApp.max_limit }.with_indifferent_access
