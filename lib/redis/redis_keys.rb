module Redis::RedisKeys
  ...
  STRAVOX_INSTALLATION_ONBOARDING = 'STRAVOX_INSTALLATION_ONBOARDING'.freeze
  STRAVOX_INSTALLATION_CONFIG_RESET_WARNING = 'STRAVOX_CONFIG_RESET_WARNING'.freeze
  LATEST_STRAVOX_VERSION = 'LATEST_STRAVOX_VERSION'.freeze
