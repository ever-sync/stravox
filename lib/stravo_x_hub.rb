...
class ::StravoXHub
  ...
  def self.support_config
    {
      support_website_token: InstallationConfig.find_by(name: 'STRAVOX_SUPPORT_WEBSITE_TOKEN')&.value,
      support_script_url: InstallationConfig.find_by(name: 'STRAVOX_SUPPORT_SCRIPT_URL')&.value,
      support_identifier_hash: InstallationConfig.find_by(name: 'STRAVOX_SUPPORT_IDENTIFIER_HASH')&.value
    }
  end
  ...
  def self.instance_config
    {
      ...
      installation_version: StravoX.config[:version],
  ...
  def self.sync_with_hub
    begin
      ...
      ::StravoXExceptionTracker.new(e).capture_exception
    end
    parsed_response
  end
