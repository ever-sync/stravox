...
const isAStravoXInstance = computed(
  () => globalConfig.value.installationName === 'StravoX'
);

onBeforeMount(() => {
  isLoading.value = isAStravoXInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAStravoXInstance }"
    >
