...
describe('useConfig', () => {
  const originalStravoXConfig = window.stravoxConfig;
  ...
  afterEach(() => {
    window.stravoxConfig = originalStravoXConfig;
  });
  ...
  it('handles undefined window.stravoxConfig', () => {
    window.stravoxConfig = undefined;
    const config = useConfig();
