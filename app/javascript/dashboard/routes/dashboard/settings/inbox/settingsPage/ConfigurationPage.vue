...
export default {
  ...
  computed: {
    ...
    whatsappAppId() {
      return window.stravoxConfig?.whatsappAppId;
    },
    isForwardingEnabled() {
    ...
    <div class="mx-8">
      ...
      >
        <woot-code
          ...
          lang="html"
          :codepen-title="`${inbox.name} - StravoX Widget Test`"
          enable-code-pen
        />
      </SettingsSection>
      ...
      >
        ...
        <template #subTitle>
          ...
          <a
            ...
            href="https://www.stravox.com/docs/product/channels/live-chat/sdk/identity-validation/"
          >
