...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about StravoX?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://stravox.dev/invoice.pdf'),
      getAttachment('file', 'https://stravox.dev/logs.txt'),
      getAttachment('file', 'https://stravox.dev/contacts.xls'),
      getAttachment('file', 'https://stravox.dev/customers.csv'),
      getAttachment('file', 'https://stravox.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://stravox.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://stravox.dev/all-files.tar'),
      getAttachment(
        'audio',
