...
const { t } = useI18n();
const { currentAccount, accountId, isOnStravoXCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnStravoXCloud.value);
const i18nKey = computed(() =>
  isOnStravoXCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
...
<template>
  ...
  >
    ...
    <BasePaywallModal
      ...
      :i18n-key="i18nKey"
      :is-on-stravox-cloud="isOnStravoXCloud"
