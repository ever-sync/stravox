export default {
  ...
  DOCS_URL: 'https://www.stravox.com/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.stravox.com/docs/product/others/help-center',
  TESTIMONIAL_URL:
    'https://testimonials.cdn.stravox.com/testimonial-content.json',
