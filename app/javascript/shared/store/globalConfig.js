...
const {
  ...
  STRAVOX_INBOX_TOKEN: stravoxInboxToken,
...
export const getters = {
  get: $state => $state,
  isOnStravoXCloud: $state => $state.deploymentEnv === 'cloud',
  isACustomBrandedInstance: $state => $state.installationName !== 'StravoX',
  isAStravoXInstance: $state => $state.installationName === 'StravoX',
};
