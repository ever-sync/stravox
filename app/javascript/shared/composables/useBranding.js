...
export function useBranding() {
  ...
  /**
   * Replaces "StravoX" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "StravoX" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/StravoX/g, installationName);
  };
