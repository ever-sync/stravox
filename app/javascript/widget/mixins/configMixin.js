export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.stravoxWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.stravoxWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.stravoxWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.stravoxWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.stravoxWebChannel.preChatFormOptions || {};
