...
describe('useAvailability', () => {
  const originalWindow = window.stravoxWebChannel;
  ...
  afterEach(() => {
    window.stravoxWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.stravoxWebChannel changes', () => {
