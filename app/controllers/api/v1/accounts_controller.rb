class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_stravox_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_STRAVOX_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless ::StravoXCaptcha.new(params[:h_captcha_client_response]).valid?
  end
