...
class Message < ApplicationRecord
  searchkick callbacks: false if ::StravoXApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless ::StravoXApp.advanced_search_allowed?
    ...
    return false if ::StravoXApp.stravox_cloud? && !account.feature_enabled?('advanced_search_indexing')
